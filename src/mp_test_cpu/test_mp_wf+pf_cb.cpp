 ...
 *  
 *  Composition: Source -> Filter -> FlatMap -> Map -> WF_CB(PF_CB) -> Sink
 */ 
...
int main(int argc, char *argv[])
{
    ...
    for (size_t i=0; i<runs; i++) {
	    ...
	    FlatMap flatmap = FlatMap_Builder(flatmap_functor)
	    						.withName("test_wf+pf_cb_flatmap")
