...
/*  
 *  Test Program of the Key_Farm Pattern (CB windows with a Incremental Query)
 *  
 *  Test program of the Key_Farm pattern instantiated with an incremental query.
...
int main(int argc, char *argv[])
{
	...
	Key_Farm kf = KeyFarm_Builder(F).withCBWindows(win_len, win_slide)
