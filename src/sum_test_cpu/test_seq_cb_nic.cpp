...
/*  
 *  Test Program of the Win_Seq Pattern (CB windows with a Non-Incremental Query)
 *  
 *  Test program of the Win_Seq pattern instantiated with a non-incremental query.
