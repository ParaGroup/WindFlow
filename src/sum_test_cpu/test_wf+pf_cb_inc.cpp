...
/*  
 *  Test Program of the nesting between Win_Farm and Pane_Farm (CB windows with an
 *  Incremental Query)
 *  
...
int main(int argc, char *argv[])
{
	...
	if (argc != 15) {
		cout << argv[0] << " -l [stream_length] -k [num keys] -w [win length] -s [win slide] -r [WF pardegree] -n [PLQ pardegree] -m [WLQ pardegree]" << endl;
		exit(EXIT_SUCCESS);
	}
