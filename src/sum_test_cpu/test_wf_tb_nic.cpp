...
/*  
 *  Test Program of the Win_Farm Pattern (TB windows with a Non-Incremental Query)
 *  
 *  Test program of the Win_Farm pattern instantiated with a non-incremental query.
