...
int main(int argc, char *argv[])
{
	...
	if (argc != 17) {
		cout << argv[0] << " -l [stream_length] -k [num keys] -w [win length usec] -s [win slide usec] -r [MAP pardegree] -n [REDUCE pardegree] -m [WLQ pardegree] -b [batch_len]" << endl;
		exit(EXIT_SUCCESS);
	}
	...
	ff_Pipe<tuple_t, tuple_t> pipe(generator, *kf_gpu, consumer);
