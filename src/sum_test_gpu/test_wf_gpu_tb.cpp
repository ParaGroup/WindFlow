...
/*  
 *  Test Program of the Win_Farm_GPU Pattern (CB windows) on GPU.
 *  
 *  Test program of the Win_Farm_GPU pattern working by offloading windows processing on GPU.
...
int main(int argc, char *argv[])
{
	...
	auto *wf_gpu = WinFarmGPU_Builder<decltype(F)>(F).withTBWindows(microseconds(win_len), microseconds(win_slide))
