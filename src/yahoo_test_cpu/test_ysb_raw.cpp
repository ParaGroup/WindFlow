...
int main(int argc, char *argv[])
{
	...
	if (argc != 5) {
		cout << argv[0] << " -l [execution_seconds] -n [par_degree]" << endl;
		exit(EXIT_SUCCESS);
	}
    ...
    EventSource source(exec_time_sec, campaign_gen.getArrays(), campaign_gen.getAdsCompaign());
