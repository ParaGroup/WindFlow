...
/*  
 *  Test 4 of general graphs of MultiPipe instances.
 *                                                                 +---------------------+
 *                                                                 |  +-----+   +-----+  |
 *                                                                 |  |  S  |   |  M  |  |
 *                                                                 |  | (*) +-->+ (*) |  +-+
...
int main(int argc, char *argv[])
{
    ...
    int map1_degree, map2_degree, map3_degree, map4_degree, map5_degree, filter1_degree, filter2_degree, filter3_degree;
    ...
    for (size_t i=0; i<runs; i++) {
        ...
        cout << "                                                               |  +-----+   +-----+  |" << endl;
        cout << "                                                               |  |  S  |   |  M  |  |" << endl;
        cout << "                                                               |  | (" << source2_degree << ") +-->+ (" << map5_degree << ") |  +-+" << endl;
        cout << "                                                               |  +-----+   +-----+  | |" << endl;
        cout << "                                                               +---------------------+ |" << endl;
        cout << "                                                                                       |" << endl;
        cout << "                                                       +-----------+                   |" << endl;
        ...
        cout << "                            |  +-----+   +-----+  | |  +-----------+ |   |  +-----+  | |  |  +-----+  |" << endl;
        cout << "                         +->+  |  F  |   |  M  |  +-+                +-->+  |  M  |  | |  |  |  S  |  |" << endl;
        cout << "                         |  |  | (" << filter1_degree << ") +-->+ (" << map2_degree << ") |  | |  +-----------+ |   |  | (" << map4_degree << ") |  +-+->+  | (1) |  |" << endl;
        cout << "                         |  |  +-----+   +-----+  | |  |  +-----+  | |   |  +-----+  | |  |  +-----+  |" << endl;
        cout << "+---------------------+  |  +---------------------+ |  |  |  F  |  | |   +-----------+ |  +-----------+" << endl;
        ...
        if (source2_degree != map5_degree)
            check_degree += map5_degree;
        check_degree++;
        // prepare the test
        PipeGraph graph("test_graph_4");
