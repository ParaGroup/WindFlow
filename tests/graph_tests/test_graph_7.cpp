...
int main(int argc, char *argv[])
{
    ...
    int map1_degree, map2_degree, map3_degree, map4_degree, map5_degree, map6_degree, map7_degree, map8_degree, flatmap1_degree, flatmap2_degree, sink1_degree;
    ...
    for (size_t i=0; i<runs; i++) {
        ...
        cout << "                         |    |  +-----+   +-----+  |   |   |  +-----+   +-----+  |" << endl;
        cout << "                         |    +---------------------+   +-->+  |  M  |   | FM  |  |" << endl;
        cout << "                         |                              |   |  | (" << map7_degree << ") +-->+ (" << flatmap1_degree << ") |  +---+" << endl;
        cout << "                         |    +---------------------+   |   |  +-----+   +-----+  |   |" << endl;
        cout << "                         |    |  +-----+   +-----+  |   |   +---------------------+   |" << endl;
        cout << "                         |    |  |  F  |   |  M  |  |   |                             |" << endl;
        ...
        cout << "|  +-----+   +-----+  |  |    |  +-----+   +-----+  |                                 |   |  +-----+  |" << endl;
        cout << "|  |  S  |   |  M  |  |  |    |  |  F  |   |  M  |  +--+                              |   |  |  S  |  |" << endl;
        cout << "|  | (" << source_degree << ") +-->+ (" << map1_degree << ") |  +--+--->+  | (" << filter3_degree << ") +-->+ (" << map4_degree << ") |  |  |                              +-->+  | (" << sink1_degree << ") |  |" << endl;
        cout << "|  +-----+   +-----+  |  |    |  +-----+   +-----+  |  |                              |   |  +-----+  |" << endl;
        cout << "+---------------------+  |    +---------------------+  |                              |   +-----------+" << endl;
        cout << "                         |                             |                              |" << endl;
        cout << "                         |    +---------------------+  |    +---------------------+   |" << endl;
        ...
        // prepare the test
        PipeGraph graph("test_graph_7 (DEFAULT)", Execution_Mode_t::DEFAULT, Time_Policy_t::EVENT_TIME);
    ...
    for (size_t i=0; i<runs; i++) {
        ...
        check_degree += sink1_degree;
        // prepare the test
        PipeGraph graph("test_graph_7 (DETERMINISTIC)", Execution_Mode_t::DETERMINISTIC, Time_Policy_t::EVENT_TIME);
        // prepare the first MultiPipe
