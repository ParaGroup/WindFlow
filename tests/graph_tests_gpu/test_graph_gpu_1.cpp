...
/*  
 *  Test 1 of general graphs with both CPU and GPU operators.
 *  
 *  +---------------------+                         +-----------+
 *  |  +-----+   +-----+  |                         |  +-----+  |
 *  |  |  S  |   |  M  |  |                         |  |  S  |  |
...
int main(int argc, char *argv[])
{
    ...
    for (size_t i=0; i<runs; i++) {
        ...
        // prepare the test
        PipeGraph graph("test_graph_gpu_1", Execution_Mode_t::DEFAULT, Time_Policy_t::EVENT_TIME);
