...
/*  
 *  Test 5 of merge between MultiPipes with both CPU and GPU operators.
 *  
 *  +---------------------------------+
 *  |  +-----+    +-----+    +-----+  |
 *  |  |  S  |    |  M  |    |  M  |  |
...
int main(int argc, char *argv[])
{
    ...
    for (size_t i=0; i<runs; i++) {
        ...
        // prepare the test
        PipeGraph graph("test_merge_gpu_5", Execution_Mode_t::DEFAULT, Time_Policy_t::EVENT_TIME);
        ...
        Map map4 = Map_Builder(map_functor4)
                        ...
                        .build();
        pipe2.chain(map4);
        Map_Functor_GPU map_functor_gpu5; 
