...
/*  
 *  Test 3 of merge between MultiPipes with both CPU and GPU operators. Version
...
int main(int argc, char *argv[])
{
    ...
    for (size_t i=0; i<runs; i++) {
        ...
        // prepare the test
        PipeGraph graph("test_merge_gpu_kb_3", Execution_Mode_t::DEFAULT, Time_Policy_t::EVENT_TIME);
        ...
        Map map4 = Map_Builder(map_functor4)
                        ...
                        .build();
        pipe2.chain(map4);
        Map_Functor_GPU_KB map_functor_gpu5;
        Map_GPU mapgpu5 = MapGPU_Builder(map_functor_gpu5)
                                .withName("mapgpu5")
