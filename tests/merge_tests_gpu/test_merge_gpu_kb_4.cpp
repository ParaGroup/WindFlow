...
/*  
 *  Test 4 of merge between MultiPipes with both CPU and GPU operators. Version
...
int main(int argc, char *argv[])
{
    ...
    for (size_t i=0; i<runs; i++) {
        ...
        // prepare the test
        PipeGraph graph("test_merge_gpu_kb_4", Execution_Mode_t::DEFAULT, Time_Policy_t::EVENT_TIME);
