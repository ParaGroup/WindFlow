...
int main(int argc, char *argv[])
{
    ...
    for (size_t i=0; i<runs; i++) {
        ...
        cout << "                               |  +-----+   +-----+   +-----+  |" << endl;
        cout << "                          +--->+  |  F  |   |  M  |   |  S  |  |" << endl;
        cout << "                          |    |  | (" << filter_degree << ") +-->+ (" << map2_degree << ") +-->+ (" << sink1_degree << ") |  |" << endl;
        cout << "                          |    |  +-----+   +-----+   +-----+  |" << endl;
        cout << "+---------------------+   |    +-------------------------------+" << endl;
        cout << "|  +-----+   +-----+  |   |    +-----------+" << endl;
        cout << "|  |  S  |   |  M  |  |   |    |  +-----+  |" << endl;
        ...
        // prepare the test
        PipeGraph graph("test_split_2 (DEFAULT)", Execution_Mode_t::DEFAULT, Time_Policy_t::EVENT_TIME);
    ...
    for (size_t i=0; i<runs; i++) {
        ...
        // prepare the test
        PipeGraph graph("test_split_2 (DETERMINISTIC)", Execution_Mode_t::DETERMINISTIC, Time_Policy_t::EVENT_TIME);
        // prepare the first MultiPipe
