...
/*  
 *  Test of the Keyed_Windows operator with time-based windows.
 *  
 *  +----------------------------------------------------------------+
 *  |  +-----+   +-----+   +------+   +-----+   +-------+   +-----+  |
 *  |  |  S  |   |  F  |   |  FM  |   |  M  |   | KW_TB |   |  S  |  |
...
int main(int argc, char *argv[])
{
    ...
    for (size_t i=0; i<runs; i++) {
        ...
        cout << "+----------------------------------------------------------------+" << endl;
        // prepare the test
        PipeGraph graph("test_win_kw_tb", Execution_Mode_t::DEFAULT, Time_Policy_t::EVENT_TIME);
    ...
    for (size_t i=0; i<runs; i++) {
        ...
        cout << "+----------------------------------------------------------------+" << endl;
        // prepare the test
        PipeGraph graph("test_win_kw_tb", Execution_Mode_t::DETERMINISTIC, Time_Policy_t::EVENT_TIME);
