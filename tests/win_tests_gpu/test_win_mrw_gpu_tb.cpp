...
int main(int argc, char *argv[])
{
    ...
    int filter_degree, map1_degree, map2_degree, map3_degree, wmap_degree, reduce_degree;
    ...
    for (size_t i=0; i<runs; i++) {
        ...
        std::cout << "+--------------------------------------------------------------------------+" << std::endl;
        std::cout << "|  +-----+     +-----+     +-----+     +-----+     +--------+     +-----+  |" << std::endl;
        std::cout << "|  |  S  |     |  F  |     |  M  |     |  M  |     | MRW_TB |     |  S  |  |" << std::endl;
        std::cout << "|  | CPU +---->+ CPU +---->+ GPU +---->+ GPU +---->+  CPU   +---->+ CPU |  |" << std::endl;
        std::cout << "|  | (" << source_degree << ") |     | (" << filter_degree << ") |     | (" << map1_degree << ") |     | (" << map2_degree << ") |     | (" << wmap_degree << "," << reduce_degree << ")  |     | (" << sink_degree << ") |  |" << std::endl;
        std::cout << "|  +-----+     +-----+     +-----+     +-----+     +--------+     +-----+  |" << std::endl;
        std::cout << "+--------------------------------------------------------------------------+" << std::endl;
        // prepare the test
        PipeGraph graph("test_win_mrw_gpu_tb", Execution_Mode_t::DEFAULT, Time_Policy_t::EVENT_TIME);
