 ...
 *  
 *  The emitter delivers each received tuple to all the destinations (without copies).
...
public:
    // Constructor
    Broadcast_Emitter(keyextr_func_t _key_extr,
                      size_t _num_dests,
                      size_t _size=0):
                      key_extr(_key_extr),
    ...
    {
        Broadcast_Emitter<keyextr_func_t> *copy = new Broadcast_Emitter<keyextr_func_t>(*this);
        return copy;
    }
    ...
    static void doEmit(Basic_Emitter *_emitter,
                       ...
                       ff::ff_monode *_node)
    {
        auto *_casted_emitter = static_cast<Broadcast_Emitter<keyextr_func_t> *>(_emitter);
    ...
    {
        return Broadcast_Emitter<keyextr_func_t>::doEmit;
    }
    ...
    {
        return Broadcast_Emitter<keyextr_func_t>::doEmit_inplace;
    }
    ...
    Broadcast_Emitter(Broadcast_Emitter &&) = delete; ///< Move constructor is deleted
    Broadcast_Emitter &operator=(const Broadcast_Emitter &) = delete; ///< Copy assignment operator is deleted
    Broadcast_Emitter &operator=(Broadcast_Emitter &&) = delete; ///< Move assignment operator is deleted
};
