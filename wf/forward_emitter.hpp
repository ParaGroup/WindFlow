...
public:
    ...
    static void doEmit(Basic_Emitter *_emitter,
                       ...
                       ff::ff_monode *_node)
    {
        auto *_casted_emitter = static_cast<Forward_Emitter<keyextr_func_t> *>(_emitter);
    ...
    {
        return Forward_Emitter<keyextr_func_t>::doEmit;
    }
    ...
    {
        return Forward_Emitter<keyextr_func_t>::doEmit_inplace;
    }
