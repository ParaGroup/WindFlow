...
public:
     ...
     *  \param _closing_func closing functional logic of the Keyed_Windows (a function or any callable type)
                  ...
                  winType(_winType)
    {
        ...
        for (size_t i=0; i<this->parallelism; i++) { // create the internal replicas of the Keyed_Windows
    ...
    Keyed_Windows(Keyed_Windows &&) = delete; ///< Move constructor is deleted
    Keyed_Windows &operator=(const Keyed_Windows &) = delete; ///< Copy assignment operator is deleted
    Keyed_Windows &operator=(Keyed_Windows &&) = delete; ///< Move assignment operator is deleted
};
