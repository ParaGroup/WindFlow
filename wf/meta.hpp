...
template<typename F_t, typename Arg, typename Ret>
Arg get_tuple_t_Join(std::optional<Ret> (F_t::*)(const Arg&, const Arg&) const); // non-riched version

template<typename F_t, typename Arg, typename Ret>
Arg get_tuple_t_Join(std::optional<Ret> (F_t::*)(const Arg&, const Arg&)); // non-riched version

template<typename Arg, typename Ret>
Arg get_tuple_t_Join(std::optional<Ret> (*)(const Arg&, const Arg&)); // non-riched version

template<typename F_t, typename Arg, typename Ret>
Arg get_tuple_t_Join(std::optional<Ret> (F_t::*)(const Arg&, const Arg&, RuntimeContext&) const); // riched version

template<typename F_t, typename Arg, typename Ret>
Arg get_tuple_t_Join(std::optional<Ret> (F_t::*)(const Arg&, const Arg&, RuntimeContext&)); // riched version

template<typename Arg, typename Ret>
Arg get_tuple_t_Join(std::optional<Ret> (*)(const Arg&, const Arg&, RuntimeContext&)); // riched version
...
// declaration of functions to extract the result type from the signature of the window function
template<typename F_t, typename Arg, typename Ret>
Ret get_result_t_Join(std::optional<Ret> (F_t::*)(const Arg&, const Arg&) const); // non-riched version

template<typename F_t, typename Arg, typename Ret>
Ret get_result_t_Join(std::optional<Ret> (F_t::*)(const Arg&, const Arg&)); // non-riched version

template<typename Arg, typename Ret>
Ret get_result_t_Join(std::optional<Ret> (*)(const Arg&, const Arg&)); // non-riched version

template<typename F_t, typename Arg, typename Ret>
Ret get_result_t_Join(std::optional<Ret> (F_t::*)(const Arg&, const Arg&, RuntimeContext&) const); // riched version

template<typename F_t, typename Arg, typename Ret>
Ret get_result_t_Join(std::optional<Ret> (F_t::*)(const Arg&, const Arg&, RuntimeContext&)); // riched version

template<typename Arg, typename Ret>
Ret get_result_t_Join(std::optional<Ret> (*)(const Arg&, const Arg&, RuntimeContext&)); // riched version

template<typename F_t>
decltype(get_result_t_Join(&F_t::operator())) get_result_t_Join(F_t);

std::false_type get_result_t_Join(...); // black hole
/*****************************************************************************************************************************/
